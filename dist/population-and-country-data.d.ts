export declare const populationAndCountryData: {
...
export declare function getPopulation(zoneId: string): number;
export declare function getCountries(zoneId: string): string;
export declare function getPopulationAndCountries(zoneId: string): string;
export declare function appendPopulationAndCountries(zoneData: string, zoneId: string): string;
